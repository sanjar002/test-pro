        ...
        <div className="update">
          <div className="updateTxt">
            ...
            <div className="updateP">
              <p>
                ОКУРМЭН окуу борбору - бул дүйнө жүзүндө актуалдуу болуп жактан
                IT тармагында билиим берүүчү <br /> академия. Биз Front-End,
                Back-End жана Flutter курстарын онлайн жана офлайн форматта
                окутабыз.
                <br /> Биздин максат - 2030 жылга чейин 100000 мыкты IT
                адистерин даярдоо жана КРны <br /> санариптештешкен
                мамлекеттердин катарына кошуу. Студенттерге сапатуу билим берүү
                менен
                ...
                <br /> ашуун киши эмгектенет. Кеңсебиз Бишкек шаарында жана
                дүйнө жүзү боюнча кыргыз тилинде
